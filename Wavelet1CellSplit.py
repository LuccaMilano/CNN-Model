...
if __name__ == "__main__":
    ...
    history = concatenated_model.fit(
        ...
        epochs=100,
        callbacks=[callback],
        validation_data=([gamma_wave_val], val_labels)
    )
    ...
    test_loss, test_accuracy = concatenated_model.evaluate([gamma_wave_test], test_labels)

    predictions = concatenated_model.predict([gamma_wave_test])
