...
from CNNCells import CNNCell1, CNNCell2, CNNCell3
...
if __name__ == "__main__":
    ...
    for fold, (train_indices, val_indices) in enumerate(kf.split(delta_wave)):
        ...
        concatenated_model.fit(
            ...
            batch_size=64,
            epochs=20,
            validation_data=([alpha_wave_val, beta_wave_val, gamma_wave_val], labels_val)
        )



    predictions = concatenated_model.predict([alpha_wave_val, beta_wave_val, gamma_wave_val])
